...
Public Class rptLoanPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.rptLoanPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLoanPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLoanPayment = New rptLoanPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
