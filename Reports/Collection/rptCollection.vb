...
Public Class rptCollection
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.rptCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCollection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCollection = New rptCollection()
        rpt.Site = Me.Site
        Return rpt
    End Function
