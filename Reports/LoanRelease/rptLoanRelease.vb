...
Public Class rptLoanRelease
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.rptLoanRelease.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLoanRelease
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLoanRelease = New rptLoanRelease()
        rpt.Site = Me.Site
        Return rpt
    End Function
